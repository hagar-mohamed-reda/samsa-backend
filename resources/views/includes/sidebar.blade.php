<div class="horizontal-menu-wrapper">
    <div class="header-navbar navbar-expand-sm navbar navbar-horizontal floating-nav navbar-light navbar-without-dd-arrow navbar-shadow menu-border" role="navigation" data-menu="menu-wrapper">
        ...
        <div class="navbar-container main-menu-content w3-display-container" data-menu="menu-container">
            ...
            <ul class="nav navbar-nav" id="main-menu-navigation"  data-menu="menu-navigation">
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <li class="dropdown dropdown-submenu" data-menu="dropdown-submenu"><a class="dropdown-item dropdown-toggle" href="#" data-toggle="dropdown" data-i18n="Ecommerce"><i class="feather icon-file"></i> {{ __('adminsion status') }}</a>
                            <ul class="dropdown-menu">
                                ...
                                <li class="{{ (request()->is('registeration-methods')) ? 'active' : '' }} " data-menu="">
                                ...
                                @endpermission
                                <li class="{{ (request()->is('case-constraint')) ? 'active' : '' }}" data-menu="">
                                    <a class="dropdown-item"  data-toggle="dropdown"  href="{{ url('case-constraint') }}" data-i18n="Analytics"><i class="feather icon-users"></i>{{ __('case-constraint') }}</a>
                                </li>
                                <li class="{{ (request()->is('constraint-status')) ? 'active' : '' }} w3-border-0" data-menu="">
                                    <a class="dropdown-item"  data-toggle="dropdown"  href="{{ url('constraint-status') }}" data-i18n="Analytics"><i class="feather icon-users"></i>{{ __('constraint-status') }}</a>
                                </li>
                        ...
                        <li class="dropdown dropdown-submenu" data-menu="dropdown-submenu"><a class="dropdown-item dropdown-toggle " href="#" data-toggle="dropdown" data-i18n="Ecommerce"><i class="fa fa-globe"></i>{{ __('users and roles') }} </a>
                            <ul class="dropdown-menu">
                        ...
                        <li class="dropdown dropdown-submenu" data-menu="dropdown-submenu"><a class="dropdown-item dropdown-toggle " href="#" data-toggle="dropdown" data-i18n="Ecommerce"><i class="fa fa-globe"></i>{{ __('other settings') }} </a>
                            <ul class="dropdown-menu">
                ...
                <li class="dropdown nav-item" data-menu="dropdown"><a class="dropdown-toggle nav-link" href="#" data-toggle="dropdown"><i class="feather icon-package"></i><span data-i18n="Apps">{{ __('applications') }}</span></a>
                    <ul class="dropdown-menu">
                        ...
                        <li class="{{ (request()->is('applications')) ? 'active' : '' }} " data-menu="">
                        ...
                        <li class="{{ (request()->is('student-code-series')) ? 'active' : '' }} " data-menu="">
                        ...
                        <li class="{{ (request()->is('required_documents')) ? 'active' : '' }} w3-border-0" data-menu="">
                            <a class="dropdown-item"  data-toggle="dropdown"  href="{{ url('required_documents') }}" data-i18n="Analytics"><i class="fa fa-newspaper-o"></i> {{ __('required_documents') }}</a>
                        </li>
                    </ul>
                </li>
                ...
                <li class="dropdown nav-item" data-menu="dropdown"><a class="dropdown-toggle nav-link" href="#" data-toggle="dropdown"><i class="feather icon-package"></i><span data-i18n="Apps">{{ __('military') }}</span></a>
                    <ul class="dropdown-menu">
                        ...
                        <li class="{{ (request()->is('military-areas')) ? 'active' : '' }} " data-menu="">
                        ...
                        <li class="{{ (request()->is('military-area-submission')) ? 'active' : '' }} " data-menu="">
                        ...
                        <li class="{{ (request()->is('military-status-reason')) ? 'active' : '' }}" data-menu="">
                        ...
                        <li class="{{ (request()->is('military-course')) ? 'active' : '' }} " data-menu="">
                ...
                <li class="dropdown nav-item" data-menu="dropdown"><a class="dropdown-toggle nav-link" href="#" data-toggle="dropdown"><i class="fa fa-calculator"></i><span data-i18n="Apps">{{ __('accounting') }}</span></a>
                    <ul class="dropdown-menu">
                        <li class="{{ (request()->is('account/banks')) ? 'active' : '' }}" data-menu="">
                            <a class="dropdown-item"  data-toggle="dropdown"  
                               href="{{ url('account/banks') }}" data-i18n="Analytics">
                                <i class="fa fa-bank"></i> {{ __('banks') }}
                            </a>
                        </li>
                        <li class="{{ (request()->is('account/stores')) ? 'active' : '' }}" data-menu="">
                            <a class="dropdown-item"  data-toggle="dropdown"  
                               href="{{ url('account/stores') }}" data-i18n="Analytics">
                                <i class="fa fa-money"></i> {{ __('stores') }}
                            </a>
                        </li>
                        <li class="{{ (request()->is('account/transformations')) ? 'active' : '' }}" data-menu="">
                            <a class="dropdown-item"  data-toggle="dropdown"  
                               href="{{ url('account/transformations') }}" data-i18n="Analytics">
                                <i class="fa fa-plane"></i> {{ __('transformations') }}
                            </a>
                        </li>
                        <li class="{{ (request()->is('account/deposites')) ? 'active' : '' }}" data-menu="">
                            <a class="dropdown-item"  data-toggle="dropdown"  
                               href="{{ url('account/deposites') }}" data-i18n="Analytics">
                                <i class="fa fa-handshake-o"></i> {{ __('deposites') }}
                            </a>
                        </li>
                        <li class="{{ (request()->is('account/expense_maincategorys')) ? 'active' : '' }}" data-menu="">
                            <a class="dropdown-item"  data-toggle="dropdown"  
                               href="{{ url('account/expense_maincategorys') }}" data-i18n="Analytics">
                                <i class="fa fa-cube"></i> {{ __('expense_maincategorys') }}
                            </a>
                        </li>
                        <li class="{{ (request()->is('account/expense_subcategorys')) ? 'active' : '' }}" data-menu="">
                            <a class="dropdown-item"  data-toggle="dropdown"  
                               href="{{ url('account/expense_subcategorys') }}" data-i18n="Analytics">
                                <i class="fa fa-cubes"></i> {{ __('expense_subcategorys') }}
                            </a>
                        </li>
                        <li class="{{ (request()->is('account/installments')) ? 'active' : '' }}" data-menu="">
                            <a class="dropdown-item"  data-toggle="dropdown"  
                               href="{{ url('account/installments') }}" data-i18n="Analytics">
                                <i class="fa fa-calendar"></i> {{ __('installments') }}
                            </a>
                        </li>
                        <li class="{{ (request()->is('account/payments')) ? 'active' : '' }}" data-menu="">
                            <a class="dropdown-item"  data-toggle="dropdown"  
                               href="{{ url('account/payments') }}" data-i18n="Analytics">
                                <i class="fa fa-money"></i> {{ __('payments') }}
                            </a>
                        </li>
                        <li class="{{ (request()->is('account/plans')) ? 'active' : '' }}" data-menu="">
                            <a class="dropdown-item"  data-toggle="dropdown"  
                               href="{{ url('account/plans') }}" data-i18n="Analytics">
                                <i class="fa fa-calendar"></i> {{ __('plans') }}
                            </a>
                        </li>
                        <li class="{{ (request()->is('account/rewords')) ? 'active' : '' }}" data-menu="">
                            <a class="dropdown-item"  data-toggle="dropdown"  
                               href="{{ url('account/rewords') }}" data-i18n="Analytics">
                                <i class="fa fa-money"></i> {{ __('rewords') }}
                            </a>
                        </li>
                        <li class="{{ (request()->is('account/fines')) ? 'active' : '' }}" data-menu="">
                            <a class="dropdown-item"  data-toggle="dropdown"  
                               href="{{ url('account/fines') }}" data-i18n="Analytics">
                                <i class="fa fa-money"></i> {{ __('fines') }}
                            </a>
                        </li>
                    </ul>
                </li>
