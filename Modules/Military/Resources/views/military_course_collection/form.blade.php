<div class="row">
    <div class="col-sm-6">
        <div class="form-group">
            <div class="controls">
                <label class="label-r" for="academic-year">{{ __('academic year') }}</label>
                {!! Form::select('academic_year_id',Modules\Settings\Entities\AcademicYear::pluck('name','id'),null,['required'=>'required','id'=>"country",'class'=>'custom-select','id'=>'customSelect', 'placeholder' =>__('select academic year')])!!}
    ...
    <div class="col-sm-6">
        <div class="form-group">
            <div class="controls">
                ...
                {!! Form::number('code',null,['class'=>'form-control','id'=>'name','placeholder'=> __('military course collection code') ])!!}
                @error('code')
                    <span class="text-danger"> {!! $message !!}</span>
                @enderror
