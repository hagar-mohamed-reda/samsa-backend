    ...
    <tr>
        ...
        <td>
            <div class="btn-group" role="group" aria-label="Basic example">
                <a href="{{route('military-status.edit', $row->id)}}">
                ...
                <form id="deleteForm{{$row->id}}" action="{{route('military-status.destroy',$row->id)}}" method="post">
                    @method("DELETE")
                    @csrf
                </form>
            </div>
