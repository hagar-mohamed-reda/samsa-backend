...
<div class="card material-shadow " >
    <div class="w3-border-bottom w3-border-light-gray w3-padding" >
        <div class="w3-margin-right w3-xlarge" ><i class="fa fa-angle-double-left" style="margin-left: 5px" ></i>{{ __('payments') }}</div>
    </div>
        ...
        <form  method="get" action="" >
            <div class="row" >
                ...
                <div class="col-lg-3 col-md-3 col-sm-6">
                    <div class="form-group">
                        <div class="controls">
                            ...
                            @endphp
                            {!! Form::select('payment_type', $type,null,['class'=>'custom-select','id'=>'customSelect select2', 'required' ])!!} 
                ...
                <div class="col-sm-6">
                    ...
                    <a role="button" href="{{ route('payments.index') }}" class="btn btn-danger waves-effect waves-light">{{ __('select all') }}</a>
                </div>
            </div>
        </form>
    </div>
