...
<html lang="en">
    <head>
        ...
        <style>
            *, table, th, td, tr, .w3-table, .w3-table-all {
    ...
    <body> 
        <div class="w3-center w3-large" >
            <b>ملف الارشاد الاكاديمى للطالب</b>
        </div>
        <br>
        <table class="w3-table w3-bordered"  >
            ...
            <tr>
                ...
                <th>حالة القيد</th>
                <td>{{ optional($student->registerationStatus)->name }}</td>
            </tr>
            <tr>
                <th>الساعات المسجلة</th>
                <td>{{ $student->courses()->sum('credit_hour') }}</td>
                
                <th>المقررات المسجلة</th>
                <td>{{ count($student->current_register_courses) }}</td>
            </tr>
            @if ($student->warning)
            <tr class="w3-text-red" >
                <th>تنبيه هام</th>
                <th colspan="3" >{{ $student->warning }}</th> 
            </tr>
            @endif
        ...
        <table class="w3-table w3-bordered"  >
            ...
            <tr>
                ...
                <td>{{ $course->code }}</td>
                <td>{{ $course->name }}</td>
                <td>{{ optional($course->division)->name }}</td>
